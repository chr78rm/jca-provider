...
//    def multiply(m: BigInt, point: Point): Element = {
...
//  class FixedPointBinaryMethod(val fixedPoint: ShortWeierstrass.Point)
...
//    def multiply(multiplier: BigInt, point: Point): Element = {
//      val tracer = getCurrentTracer()
//      withTracer("Element", this, "multiply(m: BigInt, point: AffinePoint)") {
//        
//        @tailrec
