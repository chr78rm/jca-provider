...
Curves of both compilations are critizised by the researchers [Daniel J. Bernstein](http://cr.yp.to/djb.html) and [Tanja Lange](http://hyperelliptic.org/tanja/) for
various reasons, see their site [SafeCurves: choosing safe curves for elliptic-curve cryptography](http://safecurves.cr.yp.to/index.html) for more information. This JCA provider 
therefore provides some curves recommended by this site as well. So long as all required domain parameter are provided the user may also use arbitrary curves of his own choice.

#### <a name="EllipticCurveKeyPair1"></a>4.i.a Brainpool Curves

[RFC 5639](https://tools.ietf.org/html/rfc5639) defines curves for each of the bit lengths 160, 192, 224, 256, 320, 384, and 512 together with isomorphic (quadratic)
twists. The 256-bit curve 'brainpoolP256r1' is used as default. All curves exhibit a prime number as group order, hence all points of a particular curve may serve
