...
public class SchnorrSignature extends SignatureSpi implements Traceable {
  ...
  protected void engineUpdate(byte input) throws SignatureException {
    ...
    this.schnorrSigParameterSpec.getNonceGenerator().update(input);
  }
  ...
  protected void engineUpdate(byte[] bytes, int offset, int length) throws SignatureException {
    ...
    this.schnorrSigParameterSpec.getNonceGenerator().update(bytes, offset, length);
  }
  ...
  protected byte[] engineSign() throws SignatureException {
    ...
    try {
      try {
        ...
        this.schnorrSigParameterSpec.getNonceGenerator().copy(this.messageDigest);
        
        BigInteger e, r, y;
        byte[] digestBytes;
        do {
          do {
            r = this.schnorrSigParameterSpec.getNonceGenerator().nonce();
